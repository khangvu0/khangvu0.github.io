...
function scrollHeader() {
    ...
    //when scroll > 80 viewport height, add the scroll-header class to the header tag
    if(this.scrollY >= 80) {
...
function scrollUp() {
    ...
    //when scroll > 560 viewport height, add the show-scroll class to the header tag
    if(this.scrollY >= 560){
